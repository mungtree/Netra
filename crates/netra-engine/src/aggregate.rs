...
//! up per batch from its [`AggregationSpec`](netra_core::model::AggregationSpec).
//!
...
use netra_core::model::{AgentOutput, AggregatedResult, TokenUsage};
use netra_core::traits::Aggregator;
